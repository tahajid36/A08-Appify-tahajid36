...
const Banner = () => {
    ...
    return (
        <div className='mt-20'>
            ...
            <img className='mx-auto mt-8' src={BannerImg} alt="" />


            <div className='bg-linear-to-r from-[#632EE3] to-[#9F62F2] p-[80px]'>
                <h1 className='text-6xl text-center mb-9 font-bold text-white'>Trusted By Millions, Built For You</h1>
                <div className='flex justify-around items-center'>
                    <div className='text-center'>
                        <p className='text-white'>Total Downloads</p>
                        <h2 className='text-6xl font-bold text-white'>29.6M</h2>
